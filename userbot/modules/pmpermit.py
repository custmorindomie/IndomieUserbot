...
DEF_UNAPPROVED_MSG = (
    ...
    "╚═════════════════════╝\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"**ANAK KONTOL ANAK NGENTOT,KALO NGECHAT MAJIKAN** [`{DEFAULTUSER}`] **ITU SALAM,\nHABIS ITU SABAR TUNGGU MAJIKAN GUA BALES,\nKALO GA DI BALES - BALES, LU JANGAN NYEPAM KONTOL, APA LAGI LU NGECHAT NYA CUMA MINTA VCS, BISA GUA BLOKIR!! KALO NYEPAM JUGA TAR GUA BLOKIR!!!! TUNGGU** [`{DEFAULTUSER}`] **NERIMA PESAN LU GOBLOK [⚠️]**({ALIVE_LOGO}) \n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    "╔═════════════════════╗\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄           \n"
    "┣[• 𝐁𝐘 ɪɴᴅᴏᴍɪᴇᴜꜱᴇʀʙᴏᴛ           \n"
